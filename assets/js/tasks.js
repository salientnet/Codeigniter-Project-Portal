$(document).ready(function() {
    ...
    // FIx for scroll
    $('body').on('hidden.bs.modal', '#task-tracking-stats-modal,#_task_modal,.task-modal-single', function(event) {
...
function new_task_from_relation(table, rel_type, rel_id,attrs) {
