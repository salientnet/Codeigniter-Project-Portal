    ...
    var invoiceUploadFile = Dropzone.options.invoiceUpload = {
        ...
        success: function(files, response) {
            ...
            if (response.success == true) {
                ...
                data += '<a href="#" class="text-danger" onclick="delete_invoice_attachment(this,' + response.attachment_id + '); return false;"><i class="fa fa-times"></i></a>';
                data += '</div>';
...
// Filter datatable estimates by status
