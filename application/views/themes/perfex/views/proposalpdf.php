...
$pdf->writeHTMLCell(192, '', '', '', $pdf_logo_url, 0, 1, false, true, 'L', true);
...
$pdf->writeHTMLCell(96, '', '', $y, $proposal_info, 0, 0, false, true, 'J', true);
// Proposal to
...
$pdf->writeHTMLCell(96, '', '', '', $client_details, 0, 1, false, true, 'R', true);
$pdf->ln(6);
