                ...
                <div class="col-md-6 text-right _buttons">
                   <div class="visible-xs">
                    ...
                    if ($estimate->status != 4 && $estimate->status != 3) {
                        ...
                        echo '<button type="submit" data-loading-text="'._l('wait_text').'" autocomplete="off" class="btn btn-default">'._l('clients_decline_estimate').'</button>';
                        echo form_close();
                        echo form_open($this->uri->uri_string(),array('class'=>'pull-right mright10'));
                        echo form_hidden('estimate_action',4);
                        echo '<button type="submit" data-loading-text="'._l('wait_text').'" autocomplete="off" class="btn btn-success">'._l('clients_accept_estimate').'</button>';
                        echo form_close();
