...
if (get_option('show_status_on_pdf_ei') == 1) {
    ...
    <tbody>
        <tr>
            <td></td>
            <td></td>
            <td style="background-color:rgb('.$bg_status.');color:#fff;">'.mb_strtoupper($_status) .'</td>
        </tr>
    </tbody>
    </table>';
}
...
$info_right_column .= '<b style="color:#6a6c6f"># ' . $invoice_number . '</b>';

// write the first column
$info_left_column .= pdf_logo_url();
$pdf->MultiCell(96, 0, $info_left_column, 0, 'J', 0, 0, '', '', true, 0, true, true, 0);
// write the second column
$pdf->MultiCell(96, 0, $info_right_column, 0, 'R', 0, 1, '', '', true, 0, true, false, 0);
$pdf->ln(10);
...
$pdf->writeHTMLCell(100, '', '', '', $client_details, 0, 1, false, true, 'R', true);
