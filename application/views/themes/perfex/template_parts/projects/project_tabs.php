<ul class="nav nav-tabs no-margin" role="tablist">
    ...
    <li role="presentation">
        <a data-group="project_tickets" href="<?php echo site_url('clients/project/'.$project->id.'?group=project_tickets'); ?>" role="tab"><i class="fa fa-commenting" aria-hidden="true"></i> <?php echo _l('project_tickets'); ?></a>
    </li>
    <?php } ?>
    <li role="presentation">
