                ...
                <div class="panel_s">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group hide shifter" id="estimates_status">
                            ...
                            <div class="radio radio-primary">
                                <input type="radio" id="<?php echo _l('estimate_status_draft'); ?>" value="1" name="estimate_export_status">
                                <label for="<?php echo _l('estimate_status_draft'); ?>"><?php echo _l('estimate_status_draft'); ?></label>
                            </div>
                            <div class="radio radio-primary">
                                <input type="radio" id="<?php echo _l('estimate_status_sent'); ?>" value="2" name="estimate_export_status">
                                <label for="<?php echo _l('estimate_status_sent'); ?>"><?php echo _l('estimate_status_sent'); ?></label>
                            </div>
                            <div class="radio radio-primary">
                                <input type="radio" id="<?php echo _l('estimate_status_declined'); ?>" value="3" name="estimate_export_status">
                                <label for="<?php echo _l('estimate_status_declined'); ?>"><?php echo _l('estimate_status_declined'); ?></label>
                            </div>
                            <div class="radio radio-primary">
                                <input type="radio" id="<?php echo _l('estimate_status_accepted'); ?>" value="4" name="estimate_export_status">
                                <label for="<?php echo _l('estimate_status_accepted'); ?>"><?php echo _l('estimate_status_accepted'); ?></label>
                            </div>
                            <div class="radio radio-primary">
                                <input type="radio" id="<?php echo _l('estimate_status_expired'); ?>" value="4" name="estimate_export_status">
                        ...
                        <div class="form-group hide shifter" id="invoices_status">
                            ...
                            <div class="radio radio-primary">
                                <input type="radio" id="invoice_<?php echo _l('invoice_status_unpaid'); ?>" value="1" name="invoice_export_status">
                                <label for="invoice_<?php echo _l('invoice_status_unpaid'); ?>"><?php echo _l('invoice_status_unpaid'); ?></label>
                            </div>
                            <div class="radio radio-primary">
                                <input type="radio" id="invoice_<?php echo _l('invoice_status_paid'); ?>" value="2" name="invoice_export_status">
                                <label for="invoice_<?php echo _l('invoice_status_paid'); ?>"><?php echo _l('invoice_status_paid'); ?></label>
                            </div>
                            <div class="radio radio-primary">
                                <input type="radio" id="invoice_<?php echo _l('invoice_status_not_paid_completely'); ?>" value="3" name="invoice_export_status">
                                <label for="invoice_<?php echo _l('invoice_status_not_paid_completely'); ?>"><?php echo _l('invoice_status_not_paid_completely'); ?></label>
                            </div>
                            <div class="radio radio-primary">
                                <input type="radio" id="invoice_<?php echo _l('invoice_status_overdue'); ?>" value="4" name="invoice_export_status">
                                <label for="invoice_<?php echo _l('invoice_status_overdue'); ?>"><?php echo _l('invoice_status_overdue'); ?></label>
                            </div>
                            <div class="radio radio-primary">
                                <input type="radio" id="invoice_<?php echo _l('invoice_status_cancelled'); ?>" value="5" name="invoice_export_status">
                                <label for="invoice_<?php echo _l('invoice_status_cancelled'); ?>"><?php echo _l('invoice_status_cancelled'); ?></label>
                            </div>
                        </div>
                        ...
                        <div class="radio radio-primary">
                            <input type="radio" value="1" name="proposal_export_status" id="proposal_<?php echo _l('proposal_status_open'); ?>">
                            <label for="proposal_<?php echo _l('proposal_status_open'); ?>"><?php echo _l('proposal_status_open'); ?></label>
                        </div>
                        <div class="radio radio-primary">
                            <input type="radio" value="2" name="proposal_export_status" id="proposal_<?php echo _l('proposal_status_declined'); ?>">
                            <label for="proposal_<?php echo _l('proposal_status_declined'); ?>"><?php echo _l('proposal_status_declined'); ?></label>
                        </div>
                        <div class="radio radio-primary">
                            <input type="radio" value="3" name="proposal_export_status" id="proposal_<?php echo _l('proposal_status_accepted'); ?>">
                            <label for="proposal_<?php echo _l('proposal_status_accepted'); ?>"><?php echo _l('proposal_status_accepted'); ?></label>
                        </div>
                        <div class="radio radio-primary">
                            <input type="radio" id="proposal_<?php echo _l('proposal_status_sent'); ?>" value="4" name="proposal_export_status">
                            <label for="proposal_<?php echo _l('proposal_status_sent'); ?>"><?php echo _l('proposal_status_sent'); ?></label>
                        </div>
                    </div>
