                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" class="selectpicker" data-width="100%" <?php echo $disabled; ?> data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                <option value="0" <?php if(isset($proposal)){if($proposal->status == 0){echo 'selected';}}else{echo 'selected';} ?>><?php echo _l('proposal_status_draft'); ?></option>
                                <option value="1" <?php if(isset($proposal) && $proposal->status ==1){echo 'selected';} ?>><?php echo _l('proposal_status_open'); ?></option>
