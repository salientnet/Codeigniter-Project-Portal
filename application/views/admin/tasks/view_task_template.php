                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <?php
                                    ...
                                    $copy_template .= "</div>";
                                    ?>
                                <a href="#" data-placement="bottom" data-toggle="popover" data-content="<?php echo $copy_template; ?>" data-html="true"><span class="label mtop10 label-default label-task-action"><i class="fa fa-clone pull-left"></i> Copy</span></a>
                                <?php } ?>
                                <?php if(has_permission('tasks','','edit')) { ?>
