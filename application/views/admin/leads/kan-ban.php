...
<ul class="kan-ban-col" data-col-status-id="<?php echo $status['id']; ?>">
    <li class="kan-ban-col-wrapper">
        ...
        <div class="panel-heading-bg primary-bg" <?php echo $status_color; ?> data-status-id="<?php echo $status['id']; ?>">
            ...
            <span class="heading pointer" data-order="<?php echo $status['statusorder']; ?>" data-color="<?php echo $status['color']; ?>" data-name="<?php echo $status['name']; ?>" onclick="edit_status(this,<?php echo $status['id']; ?>); return false;"><?php echo $status['name']; ?>
            </span>
                ...
                <ul class="status leads-status sortable" data-lead-status-id="<?php echo $status['id']; ?>">
                    <?php
                        ...
                        $defaut_leads_kanban_sort_type = get_option('defaut_leads_kanban_sort_type');
                          ...
                          $this->db->select('*,tblleads.name as lead_name,tblleadssources.name as source_name,tblleads.id as id');
                        ...
                        if ($this->input->get('search')) {
                           ...
                           $this->db->or_like('tblleadssources.name', $q);
                        ...
                        <div class="panel-body lead-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right text-muted">
                                    ...
                                    <i class="fa fa-paperclip"></i> <?php echo $total_notes; ?>
                                    </span>
