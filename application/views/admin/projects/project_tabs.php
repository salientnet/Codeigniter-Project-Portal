<ul class="nav nav-tabs no-margin" role="tablist">
    ...
    <li>
        <a data-group="project_tickets" href="<?php echo admin_url('projects/view/'.$project->id.'?group=project_tickets'); ?>" role="tab"><i class="fa fa-ticket" aria-hidden="true"></i> <?php echo _l('project_tickets'); ?></a>
    </li>
    <?php } ?>
    <li>
    ...
    <li>
        <a data-group="project_expenses" href="<?php echo admin_url('projects/view/'.$project->id.'?group=project_expenses'); ?>" role="tab"><i class="fa fa-heartbeat" aria-hidden="true"></i> <?php echo _l('project_expenses'); ?></a>
    </li>
    <?php } ?>
