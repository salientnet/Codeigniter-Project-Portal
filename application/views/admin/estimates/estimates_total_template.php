...
<div class="<?php echo $col; ?> stats-total-currency">
    <div class="panel_s">
        <div class="panel-body">
            <select class="selectpicker" name="estimate_total_currency" onchange="init_estimates_total();" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
...
<?php foreach($totals as $status => $data){
    $class = estimate_status_color_class($status);
    $name = estimate_status_by_id($status);
    ?>
