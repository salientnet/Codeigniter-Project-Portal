        ...
        <div class="row">
            <div class="col-md-6 border-right">
                ...
                <?php
                    ...
                    $next_invoice_number = get_option('next_estimate_number');
            ...
            <table class="table estimate-items-table items table-main-estimate-edit">
                ...
                <tbody>
                    <tr class="main">
                        ...
                        <td>
                            <input type="number" name="quantity" value="1" class="form-control" placeholder="<?php echo _l('item_quantity_placeholder'); ?>">
                        </td>
                        <td>
                            <input type="text" name="rate" class="form-control" placeholder="<?php echo _l('item_rate_placeholder'); ?>">
                        </td>
                        <td>
                            <?php
