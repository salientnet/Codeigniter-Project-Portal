                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <a href="#" onclick="show_estimates_by_status(1); return false;">
                                    <h5 class="bold"><?php echo _l('estimate_status_draft'); ?></h5>
                                </a>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <a href="#" onclick="show_estimates_by_status(2); return false;">
                                    <h5 class="bold"><?php echo _l('estimate_status_sent'); ?></h5>
                                </a>
                            </div>
                            <div class="col-md-3 text-right bold">
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <a href="#" onclick="show_estimates_by_status(3); return false;">
                                    <h5 class="bold"><?php echo _l('estimate_status_declined'); ?></h5>
                                </a>
                            </div>
                            <div class="col-md-3 text-right bold">
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <a href="#" onclick="show_estimates_by_status(5); return false;">
                                    <h5 class="bold"><?php echo _l('estimate_status_expired'); ?></h5>
                                </a>
                            </div>
                            <div class="col-md-3 text-right bold">
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <a href="#" onclick="show_estimates_by_status(4); return false;">
                                    <h5 class="bold"><?php echo _l('estimate_status_accepted'); ?></h5>
                                </a>
                            </div>
                            <div class="col-md-3 text-right bold">
