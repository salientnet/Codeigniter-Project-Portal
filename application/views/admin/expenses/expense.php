         ...
         <div class="col-md-6">
            <div class="panel_s">
               ...
               <div class="panel-body">
                  ...
                  <?php echo render_input('amount','expense_add_edit_amount',$value); ?>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <select name="repeat_type_custom" id="repeat_type_custom" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                              ...
                              <option value="week" <?php if(isset($expense) && $expense->custom_recurring == 1 && $expense->recurring_type == 'week'){echo 'selected';} ?>>W<?php echo _l('expense_recuring_weeks'); ?></option>
