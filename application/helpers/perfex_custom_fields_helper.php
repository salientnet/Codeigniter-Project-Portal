    ...
    if (count($fields)) {
        foreach ($fields as $field) {
            ...
            if ($field['type'] == 'input') {
                ...
                $_field .= '<select ' . $select_attrs . ' name="custom_fields[' . $field['fieldto'] . '][' . $field['id'] . ']" class="selectpicker form-control" style="display:block !important;" data-width="100%" data-none-selected-text="'._l('dropdown_non_selected_tex').'">';
